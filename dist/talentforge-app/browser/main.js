...
import {
  ...
  style,
  ɵPRE_STYLE
} from "./chunk-AK7Q3UBH.js";
import {
  MainLayoutComponent
} from "./chunk-5SCB54UF.js";
...
var ErrorTrackingService = class _ErrorTrackingService {
  handleError(error) {
  ...
  static {
    this.\u0275fac = function ErrorTrackingService_Factory(t) {
      return new (t || _ErrorTrackingService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ErrorTrackingService, factory: _ErrorTrackingService.\u0275fac, providedIn: "root" });
  }
};
...
var authReducer = createReducer(initialAuthState, on(login, register, (state) => __spreadProps(__spreadValues({}, state), {
  loading: true,
  error: null
})), on(loginSuccess, registerSuccess, (state, { response }) => __spreadProps(__spreadValues({}, state), {
  user: response.user,
  token: response.token,
  isAuthenticated: true,
  loading: false,
  error: null
})), on(loginFailure, registerFailure, (state, { error }) => __spreadProps(__spreadValues({}, state), {
  loading: false,
  error
})), on(logout, () => initialAuthState), on(clearError, (state) => __spreadProps(__spreadValues({}, state), {
  error: null
})));
...
var AuthEffects = class _AuthEffects {
  constructor(actions$, authService, router) {
    ...
    this.authService = authService;
    this.router = router;
    this.login$ = createEffect(() => this.actions$.pipe(ofType(login), exhaustMap((action) => this.authService.login(action.credentials).pipe(map((response) => loginSuccess({ response })), catchError((error) => of(loginFailure({ error: error.message })))))));
    this.register$ = createEffect(() => this.actions$.pipe(ofType(register), exhaustMap((action) => this.authService.register(action.userData).pipe(map((response) => registerSuccess({ response })), catchError((error) => of(registerFailure({ error: error.message })))))));
  ...
  static {
    this.\u0275fac = function AuthEffects_Factory(t) {
      return new (t || _AuthEffects)(\u0275\u0275inject(Actions), \u0275\u0275inject(AuthService), \u0275\u0275inject(Router));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AuthEffects, factory: _AuthEffects.\u0275fac });
  }
};
...
var routes = [
  {
    path: "home",
    loadComponent: () => import("./chunk-D4FLLF7I.js").then((m) => m.HomepageComponent)
  },
  {
    path: "",
    redirectTo: "/home",
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-7VWUBDEH.js").then((m) => m.AuthModule)
  },
  {
    path: "dashboard",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-I6AZ3GQO.js").then((m) => m.DashboardComponent)
  },
  {
    path: "jobs",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-TFILERP2.js").then((m) => m.JobsBrowseComponent)
  },
  {
    path: "jobs/create",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-F6PO5QWK.js").then((m) => m.JobsCreateComponent)
  },
  {
    path: "jobs/:id",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-46FHGHFS.js").then((m) => m.JobDetailsComponent)
  },
  {
    path: "applications",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-NGHEDP2H.js").then((m) => m.ApplicationsManageComponent)
  },
  {
    path: "candidates",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-4QCGIERE.js").then((m) => m.CandidatesSearchComponent)
  },
  {
    path: "clients",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-AXYC4Z4X.js").then((m) => m.ClientsManageComponent)
  },
  {
    path: "clients/:id",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-GNZWX7QG.js").then((m) => m.ClientDetailsComponent)
  },
  {
    path: "users",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-HJP3NFQ3.js").then((m) => m.UsersManageComponent)
  },
  {
    path: "analytics",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-L5M77FGO.js").then((m) => m.AnalyticsComponent)
  },
  {
    path: "settings",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-A2ASGDRD.js").then((m) => m.SettingsComponent)
  },
  {
    path: "recruiter/profile",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-FDL5D57P.js").then((m) => m.CandidateProfileComponent)
  },
  {
    path: "admin/profile",
    canActivate: [AuthGuard],
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-IT4PMOYL.js").then((m) => m.PlatformAdminDashboardComponent)
  },
  {
    path: "platform-admin/tenants",
    canActivate: [AuthGuard, roleGuard([UserRole.PLATFORM_ADMIN, UserRole.PLATFORM_SUPER_ADMIN])],
    loadComponent: () => import("./chunk-G4CBVFTT.js").then((m) => m.TenantsManageComponent)
  },
  {
    path: "platform-admin/billing",
    canActivate: [AuthGuard, roleGuard([UserRole.PLATFORM_ADMIN, UserRole.PLATFORM_SUPER_ADMIN])],
    loadComponent: () => import("./chunk-GX6WNURA.js").then((m) => m.BillingComponent)
  },
  {
    path: "platform-admin/system",
    canActivate: [AuthGuard, roleGuard([UserRole.PLATFORM_ADMIN, UserRole.PLATFORM_SUPER_ADMIN])],
    loadComponent: () => import("./chunk-S5235LQC.js").then((m) => m.SystemComponent)
  },
  {
    path: "admin",
    canActivate: [AuthGuard, roleGuard([UserRole.TENANT_ADMIN])],
    loadComponent: () => import("./chunk-GVLAQCW6.js").then((m) => m.AdminDashboardComponent)
  },
  {
    path: "admin/invite-user",
    canActivate: [AuthGuard, roleGuard([UserRole.TENANT_ADMIN, UserRole.PLATFORM_ADMIN, UserRole.PLATFORM_SUPER_ADMIN])],
    loadComponent: () => import("./chunk-4R6DO2D6.js").then((m) => m.InviteUserComponent)
  },
  {
    path: "billing",
    canActivate: [AuthGuard, roleGuard([UserRole.BILLING_MANAGER])],
    loadComponent: () => import("./chunk-LNLV5KYJ.js").then((m) => m.BillingDashboardComponent)
  },
  {
    path: "billing/subscriptions",
    canActivate: [AuthGuard, roleGuard([UserRole.BILLING_MANAGER])],
    loadComponent: () => import("./chunk-Z2F5BL2Z.js").then((m) => m.BillingSubscriptionsComponent)
  },
  {
    path: "billing/reports",
    canActivate: [AuthGuard, roleGuard([UserRole.BILLING_MANAGER])],
    loadComponent: () => import("./chunk-7Z3MBNEN.js").then((m) => m.BillingReportsComponent)
  },
  {
    path: "client-login",
    loadComponent: () => import("./chunk-MLI3JEXG.js").then((m) => m.ClientLoginComponent)
  },
  {
    path: "client-register",
    loadComponent: () => import("./chunk-HMPVGRDJ.js").then((m) => m.ClientRegisterComponent)
  },
  {
    path: "client-dashboard",
    loadComponent: () => import("./chunk-UWYYAQTJ.js").then((m) => m.ClientDashboardComponent)
  },
  {
    path: "client",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-GI4LWVAJ.js").then((m) => m.ClientDashboardComponent)
  },
  {
    path: "client/jobs",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-BRE5QVET.js").then((m) => m.ClientJobsComponent)
  },
  {
    path: "client/candidates",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-GFUMTPZP.js").then((m) => m.ClientCandidatesComponent)
  },
  {
    path: "client/interviews",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-WZZZE5ZE.js").then((m) => m.ClientInterviewsComponent)
  },
  {
    path: "candidate",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-CZ5FKCJU.js").then((m) => m.CandidateDashboardComponent)
  },
  {
    path: "candidate/jobs",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-C2IXSAGI.js").then((m) => m.CandidateJobsComponent)
  },
  {
    path: "candidate/applications",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-CLA2FA55.js").then((m) => m.CandidateApplicationsComponent)
  },
  {
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-UZQ3CNST.js").then((m) => m.CandidateInterviewsComponent)
  },
  {
    path: "candidate/messages",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-2EEOL2HV.js").then((m) => m.CandidateMessagesComponent)
  },
  {
    path: "auth/forgot-password",
    loadComponent: () => import("./chunk-EEIMVEJV.js").then((m) => m.ForgotPasswordComponent)
  },
  {
    path: "auth/reset-password/:token",
    loadComponent: () => import("./chunk-452PA24W.js").then((m) => m.ResetPasswordComponent)
  },
  {
    path: "auth/verify-email/:token",
    loadComponent: () => import("./chunk-OPQIFFSE.js").then((m) => m.VerifyEmailComponent)
  },
  {
    path: "auth/accept-invitation/:token",
    loadComponent: () => import("./chunk-OE7VOBNJ.js").then((m) => m.AcceptInvitationComponent)
  },
  {
    path: "legal/terms",
    loadComponent: () => import("./chunk-IARCQ47F.js").then((m) => m.TermsAndConditionsComponent)
  },
  {
    path: "legal/privacy",
    loadComponent: () => import("./chunk-VK4UY3ZN.js").then((m) => m.PrivacyPolicyComponent)
  },
  {
    path: "**",
    redirectTo: "/home"
...
var AnalyticsService = class _AnalyticsService {
  ...
  static {
    this.\u0275fac = function AnalyticsService_Factory(t) {
      return new (t || _AnalyticsService)(\u0275\u0275inject(Router));
    };
  }
  static {
...
var WebVitalsService = class _WebVitalsService {
  initializeWebVitals() {
    if (!environment.production)
      return;
  ...
  static {
    this.\u0275fac = function WebVitalsService_Factory(t) {
      return new (t || _WebVitalsService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _WebVitalsService, factory: _WebVitalsService.\u0275fac, providedIn: "root" });
  }
};
...
var AppComponent = class _AppComponent {
  constructor(router, analytics, webVitals) {
    this.router = router;
    this.analytics = analytics;
    this.webVitals = webVitals;
    this.title = "talentforge-app";
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(t) {
      return new (t || _AppComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(AnalyticsService), \u0275\u0275directiveInject(WebVitalsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 1, template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, AppComponent_Conditional_0_Template, 2, 0, "app-main-layout")(1, AppComponent_Conditional_1_Template, 1, 0);
      }
      if (rf & 2) {
        \u0275\u0275conditional(0, ctx.showLayout ? 0 : 1);
      }
    }, dependencies: [CommonModule, RouterOutlet, MainLayoutComponent] });
  }
};
(() => {
